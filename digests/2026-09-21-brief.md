...
<div style="margin-bottom:6px"><span style="display:inline-block;background:#6B6B6B;color:#fff;font-size:11px;font-weight:700;letter-spacing:.3px;padding:2px 8px;border-radius:10px;margin-right:8px;vertical-align:middle">fiscaal</span> <span style="font-weight:700;font-size:14px;line-height:1.35"><a href="https://vastgoedinsider.nl/vastgoed-belang-door-extreem-hoge-belastingdruk-op-woningverhuur-box-3-doel-van-100-000-woningen/" style="color:#12242c;text-decoration:none">Vastgoed Belang: Door ‘extreem hoge belastingdruk’ op woningverhuur en zelfs verdere stijging in box 3 is doel van 100.000 woningen per jaar niet realistisch</a></span></div>
<div style="font-size:13px;color:#1a2830;margin-bottom:4px">Vastgoed Belang waarschuwt dat hoge belastingdruk op verhuur, met verdere stijging in box 3, het bouwdoel van 100.000 woningen per jaar onhaalbaar maakt.</div>
<div style="font-size:13px;color:#4a5b63;font-style:italic">Toenemende box 3-belasting verlaagt het netto rendement na belasting voor particuliere verhuurders in dit segment.</div>
<div style="font-size:11px;color:#7a8a92;margin-top:8px">Vastgoed Insider . <a href="https://vastgoedinsider.nl/vastgoed-belang-door-extreem-hoge-belastingdruk-op-woningverhuur-box-3-doel-van-100-000-woningen/" style="color:#4a7a72;text-decoration:none">lezen</a></div>
</div>
...
<div style="font-size:13px;color:#4a5b63;font-style:italic">Regeling betreft compensatie voor bewoners bij blokverwarming en heeft geen directe invloed op investeringsstrategie of vastgoedwaarde.</div>
